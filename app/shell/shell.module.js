System.register(['@angular/router', '@angular/core', './header.component', './menu.component', './sidebar.component', './../user-profile/user-profile.module'], function(exports_1, context_1) {
    "use strict";
    ...
    var router_1, core_1, header_component_1, menu_component_1, sidebar_component_1, user_profile_module_1;
    var ShellModule;
    return {
        setters:[
            function (router_1_1) {
